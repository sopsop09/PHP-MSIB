    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
                ...
                <p class="fst-italic">
                Halo, saya sofia arizka. Saya merupakan mahasiswa semester 5 di Politeknik Negeri Medan. Saat ini saya mengikuti Studi Independen di NF Komputer
                </p>
                <div class="row">
                    <div class="col-lg-6">
                        <ul>
                            <li><i class="bi bi-chevron-right"></i> <strong>Birthday:</strong> <span>09 May 2002</span>
                            </li>
                            <li><i class="bi bi-chevron-right"></i> <strong>Website:</strong>
                                <span>www.sofi.com</span>
                            </li>
                            <li><i class="bi bi-chevron-right"></i> <strong>Phone:</strong> <span>0831-9820-1427</span>
                            </li>
                            <li><i class="bi bi-chevron-right"></i> <strong>City:</strong> <span>Medan, Sumatera Utara</span>
                            </li>
                        </ul>
                    </div>
                    <div class="col-lg-6">
                        <ul>
                            ...
                            <li><i class="bi bi-chevron-right"></i> <strong>PhEmailone:</strong>
                                <span>sofiaarizka22@gmail.com</span>
                            </li>
